       ...
       { productDetail.map((product) => (
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{productDetail[0].title}</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">Product information</h2>
            <p className="text-3xl tracking-tight text-gray-900">$ {productDetail[0].price}</p>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        productDetail[0].rating > rating ? 'text-gray-900' : 'text-gray-200',
                ...
                <p className="sr-only">{productDetail[0].rating} out of 5 stars</p>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{productDetail[0].description}</p>
              </div>
            </div>
